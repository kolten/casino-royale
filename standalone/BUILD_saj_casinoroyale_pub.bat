...
echo javac -sourcepath ..\src -cp "saj_casinoroyale_types.jar;classes\;C:\HDE\x86_64.win64\jar\dcpssaj.jar;" -d classes\ ..\src\CasinoRoyaleDataPublisher.java
javac -sourcepath ..\src -cp "saj_casinoroyale_types.jar;classes\;C:\HDE\x86_64.win64\jar\dcpssaj.jar;" -d classes\ ..\src\CasinoRoyaleDataPublisher.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
