...
echo javac -sourcepath ..\src -cp "saj_casinoroyale_types.jar;classes\;..\dcpssaj.jar;" -d classes\ ..\src\CasinoRoyaleDataPublisher.java
javac -sourcepath ..\src -cp "saj_casinoroyale_types.jar;classes\;..\dcpssaj.jar;" -d classes\ ..\src\CasinoRoyaleDataPublisher.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
