...
{
    private static java.lang.String idl_type_name = "CasinoRoyaleData::Msg";
    ...
    {
        super("CasinoRoyaleData/MsgDataReaderImpl",
            "CasinoRoyaleData/MsgDataReaderViewImpl",
            "CasinoRoyaleData/MsgDataWriterImpl",
            "(LCasinoRoyaleData/MsgTypeSupport;)V",
            "null",
            "null");
        ...
        try {
            success = org.opensplice.dds.dcps.FooTypeSupportImpl.Alloc(
                    ...
                    idl_type_name,
                    idl_key_list,
                    CasinoRoyaleData.MsgMetaHolder.metaDescriptor);
